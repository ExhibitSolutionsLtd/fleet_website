...
import rv from "../assets/rv.png"; // Correctly import Hero image
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <img src={rv} alt="Company Hero" className="w-12" />
            </div>
            <p>Malik Heights, 6th Floor, 601, Ngong Road</p>
          </div>

          {/* Navbar links to Features, About Us, and Contact Us */}
          <div className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <ul className="text-base font-semibold space-y-2">
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:info@exhibitsolutions.co.ke" className="hover:underline">
                  info@exhibitsolutions.co.ke
                </a>
              </li>
              <li className="flex items-center space-x-3">
                <FaPhone className="text-gray-300" /> {/* Adjust icon color */}
                <a href="tel:+254727522626" className="hover:underline">
                  +254 727 522 626
                </a>
              </li>
            </ul>
