...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Content Section */}
      <div className="relative z-10 flex flex-col justify-center px-5 md:px-20 w-3/4 ml-12 max-md:w-[90%] max-md:px-2 max-md:mx-auto ">
        <div className="text-left">
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 drop-shadow-lg">
            FLEET MANAGEMENT
          </h1>
          <p className="text-lg md:text-xl text-white leading-8 mb-8 drop-shadow-lg">
          ...
          <div className="space-x-4 flex">
            <button
              className="primary-btn uppercase bg-white text-black px-6 py-3 rounded-md hover:bg-black hover:text-white transition-shadow shadow-lg shadow-black/50"
              onClick={() => {
